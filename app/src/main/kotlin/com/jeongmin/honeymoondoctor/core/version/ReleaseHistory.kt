...
object ReleaseHistory {
    ...
    val entries: List<ReleaseEntry> = listOf(
        ...
        ReleaseEntry(
            ...
            date = "2026-08-20",
            changes = listOf(
                "닉네임을 설정할 수 있습니다(전체 → 설정 → 계정). 지금 보고 있는 여행의 " +
                    "구성원 표시 이름에도 함께 반영됩니다.",
                "쪽지의 \"아직 안 봄/확인함\" 문구가 카카오톡·왓츠앱에 익숙한 체크마크로 " +
                    "바뀝니다.",
                "쪽지 알림을 탭하면 쪽지함으로 바로 이동합니다.",
                "\"우리 위치\" 화면에서 지금 내 위치를 쪽지로 바로 보낼 수 있습니다 — " +
                    "\"역까지 데리러 와줘\"처럼 상대가 지금 안 보고 있어도 다음에 열 때 남습니다.",
                "쪽지 안의 링크(지도 링크 등)를 탭하면 바로 열립니다. 이제 그냥 텍스트가 " +
                    "아니라 실제로 누를 수 있는 링크로 표시됩니다.",
            ),
        ),
        ReleaseEntry(
            versionName = "0.7.7",
